...
const Estudante = forwardRef((props, ref) => {
    ...
    return (
        <div className="inputFieldContainer">
            ...
            <div><p>Foto</p><input type="file" value={foto} onChange={(e) => setFoto(e.target.value)} /></div>
            <div><p>CPF</p><input type="number" value={cpf} onChange={(e) => setCpf(e.target.value)} /></div>
            <div><p>Comprovante de escolaridade</p><input type="file" value={comprovanteEscolaridade} onChange={(e) => setComprovanteEscolaridade(e.target.value)} /></div>
